...
const {JSDOM} = jsdom;
const dom = new JSDOM(`<!DOCTYPE html><p>Test</p>`, {url: "https://www.zhihu.com/"});
window = dom.window
...
!function () {
    ...
    _type_of._ = _type_of._type_of = tr
...
function get_x96(_str='') {
    _md5 = _str ? CryptoJS.MD5(_str) :"46433269d4e3a251272ac1afd55c612f"
    return window.DD(_md5)
}

// console.log(window.DD('f4ddf1cb5499d6bcc4580ceba0de2c9c'))
//DOTQGgDw5SFSdAeo6BkwW5K=5U7HIpzPSTZQSM9gOZPyKveDClwXOz/kzzmoxgrG
